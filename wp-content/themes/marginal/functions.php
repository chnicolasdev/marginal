...
function marginal_script_enqueue() {
	...
	wp_enqueue_style('bootstrap', get_template_directory_uri() . '/lib/bootstrap/css/bootstrap.min.css', array(), '3.3.7', 'all');

	wp_enqueue_style('font', get_template_directory_uri() . '/lib/font-awesome/css/font-awesome.min.css', array(), '4.7.0', 'all');
	...
	wp_enqueue_script('bootstrapjs', get_template_directory_uri() . '/lib/bootstrap/js/bootstrap.min.js', array(), '3.3.7', true);
	...
	wp_enqueue_script('morphext', get_template_directory_uri() . '/lib/morphext/morphext.min.js', array(), '2.4.4', true);
	wp_enqueue_script('wow', get_template_directory_uri() . '/lib/wow/wow.min.js', array(), '1.1.2', true);
